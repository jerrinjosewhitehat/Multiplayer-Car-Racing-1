class Game {
  ...
  play() {
    ...
    player.getCarsAtEnd(); // initialize player.rank prop withcars at end
    ...
    if (allPlayers !== undefined) {
      ...
      if (player.positionY > finshLine) {
        gameState = 2; //  game state as end
        player.rank += 1; // rank is updated
        Player.updateCarsAtEnd(player.rank); // update cars at end
        player.update(); // update rank in db
        this.showRank();
      }
